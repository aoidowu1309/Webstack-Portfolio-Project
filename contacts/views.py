                                                                                                    ...
                                                                                                    message = request.POST['message']
                                                                                                            ...
                                                                                                            if request.user.is_authenticated:
                                                                                                                            user_id = request.user.id
                                                                                                                                        has_contanted = Contact.objects.all().filter(car_id=car_id, user_id=user_id)
                                                                                                                                                    if has_contanted:
                                                                                                                                                                        messages.error(request, 'You have already made an inquity about this car. Please wait until we get back to you')
